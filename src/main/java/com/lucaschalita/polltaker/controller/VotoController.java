...
public class VotoController {
	...
	public ResponseEntity<List<Voto>> buscarPorUsuario(
			@PathVariable Long id) {


		return ResponseEntity.ok(
				votoService.buscarVotosPorUsuario(id)
		);
	}
	...
	@GetMapping("/opcao/{id}")
	public ResponseEntity<List<Voto>> buscarPorOpcao(
			@PathVariable Long id) {


		return ResponseEntity.ok(
				votoService.buscarVotosPorOpcao(id)
		);
	}
}